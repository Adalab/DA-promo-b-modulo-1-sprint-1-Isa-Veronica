...
SELECT MIN(unit_price) AS LowestPrice, MAX(unit_price) AS higestPrice
FROM products;
...
y el precio medio de todos ellos (en general, 
...
desde el departamento de Ventas quieren conocer qué productos en concreto se venden por encima 
del precio medio para todos los productos de la empresa, ya que sospechan que dicho 
número es demasiado elevado. 
