...
Supongamos que en nuestro primer día en la empresa nos cuentan que la misma se encuentra en un momento 
de reestructuración de su negocio. 
...
Ahora compara los datos de los productos anteriores con los de aquellos productos con un precio menor
15 dólares, pero sólo aquellos que tienen un ID menor que 10 
...
pero haciendo uso del operador NOT.*/
...
A Northwind le interesa conocer los datos de los países que hacen pedidos (orders) para focalizar 
el negocio en esas regiones y al mismo tiempo crear campañas de marketing para conseguir mejorar 
